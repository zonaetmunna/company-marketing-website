    ...
    <section className="relative w-full overflow-hidden py-20 md:py-32">
      <div className="container relative z-10 px-4 md:px-6">
        ...
        >
          ...
          />
          <TextReveal
            text="We're looking for passionate individuals to join our team and help us build innovative solutions that transform industries."
